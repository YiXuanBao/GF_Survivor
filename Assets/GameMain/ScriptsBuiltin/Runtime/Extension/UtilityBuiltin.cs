...
public static class UtilityBuiltin
{
    ...
    public static class AssetsPath
    {
        ...
        {
            return Utility.Text.Format("Assets/GameMain/DataTable/{0}.txt", name);
        }

        public static string GetSoundPath(string name)
        {
            return Utility.Text.Format("Assets/GameMain/Audio/{0}", name);
        }

        public static string GetScenePath(string name)
        {
            return Utility.Text.Format("Assets/GameMain/Scene/{0}.unity", name);
        }
        public static string GetEntityPath(string name)
        {
            return Utility.Text.Format("Assets/GameMain/Prefabs/Entity/{0}.prefab", name);
        }

        public static string GetUIFormPath(string v)
        {
            return Utility.Text.Format("Assets/GameMain/Prefabs/UI/{0}.prefab", v);
        }

        public static string GetTexturePath(string fileName)
        {
            return Utility.Text.Format("Assets/GameMain/Textures/{0}", fileName);
        }
        public static string GetSpritesPath(string fileName)
        {
            return Utility.Text.Format("Assets/GameMain/Sprites/{0}", fileName);
        }
        public static string GetConfigPath(string v)
        {
            return Utility.Text.Format("Assets/GameMain/Config/{0}.txt", v);
        }
        public static string GetScriptableConfigPath(string v)
        {
            return Utility.Text.Format("Assets/GameMain/ScriptableAssets/{0}.asset", v);
        }

        public static string GetPrefab(string v)
        {
            return Utility.Text.Format("Assets/GameMain/Prefabs/{0}.prefab", v);
        }

        public static string GetLanguagePath(string v)
        {
            return Utility.Text.Format("Assets/GameMain/Language/{0}.json", v);
        }
        public static string GetMaterialPath(string v)
        {
            return Utility.Text.Format("Assets/GameMain/Material/{0}.mat", v);
        }
