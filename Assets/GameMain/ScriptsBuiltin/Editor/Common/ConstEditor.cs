...
namespace UGF.EditorTools
{
    ...
    public class ConstEditor
    {
        ...
        public const string UIViewScriptFile = "Assets/GameMain/Scripts/UI/Core/UIViews.cs";
        ...
        public const string ConstGroupScriptFileFullName = "Assets/GameMain/Scripts/Common/Core/Const.Groups.cs";

        public static readonly string PrefabsPath = "Assets/GameMain/Prefabs";
        public static readonly string ScenePath = "Assets/GameMain/Scene";

        public const string DataTableCodeTemplate = "Assets/GameMain/ScriptsBuiltin/Editor/DataTableGenerator/DataTableCodeTemplate/DataTableCodeTemplate.txt"; //生成配置表代码的模板文件
        ...
        public const string UIFormTemplate = "Assets/GameMain/ScriptsBuiltin/Editor/UI/Templates/UIFormTemplate.prefab";
        public const string UIDialogTemplate = "Assets/GameMain/ScriptsBuiltin/Editor/UI/Templates/UIDialogTemplate.prefab";
    }
}
#endif